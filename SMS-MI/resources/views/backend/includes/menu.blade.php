<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#man" aria-expanded="false" aria-controls="sidebarEmail" class="side-nav-link">
                    <i class="uil-book-open"></i>
                    <span> Academic Manage </span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="man">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{route('groups.index')}}">Student Group</a>
                        </li>
                        <li>
                            <a href="{{route('stages.index')}}">Educational Stage</a>
                        </li>
                        <li>
                            <a href="{{route('years.index')}}">Academic Year</a>
                        </li>
                        <li>
                            <a href="{{route('classes.index')}}">Academic Classes</a>
                        </li>
                        <li>
                            <a href="{{route('sections.index')}}">Section </a>
                        </li>
                        <li>
                            <a href="{{route('schedules.index')}}">Classe Schedule</a>
                        </li>
                    </ul>
                </div>
            </li>
